...
const StaffLayout = ({ children }) => {
    ...
    return (
        <div className="flex h-screen bg-gray-100">
            ...
            {/* Sidebar */}
            <aside 
                className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'} fixed md:relative z-50 md:z-auto w-64 md:w-64 bg-gradient-to-b from-teal-700 to-green-700 text-white transition-transform duration-300 flex flex-col h-full`}
