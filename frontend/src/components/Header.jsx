            ...
            <div className="fixed inset-0 z-[100] flex justify-end">
                ...
                >
                    ...
                    <div className="flex-1 overflow-y-auto p-3 sm:p-4">
                        ...
                        {/* Contact Support */}
                        <div className="mb-4">
                            <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-2 px-2">Support</p>
                            <button
                                onClick={() => {
                                    setShowSidePanel(false);
                                ...
                                className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-blue-50 transition-all duration-200 group text-left"
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500 truncate">Send a message to admin</p>
                                </div>
                    ...
                    <div className="p-4 sm:p-6 overflow-y-auto">
                        {emailSent ? (
                            <div className="text-center py-6">
                                ...
                                <p className="text-gray-600 mb-4">Your message has been sent to the admin team. They will respond as soon as possible.</p>
                                <button
                                    onClick={() => {
                                        setShowEmailModal(false);
                                        setEmailSent(false);
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    className="w-full bg-blue-600 text-white py-2.5 rounded-lg font-semibold hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                >
                                    {emailLoading ? (
                                        <>
