    ...
    return (
        <ReactLenis root>
            <div className="bg-[#ebebeb] text-[#212631] relative min-h-screen">
                ...
                <main id="community-feed" className="relative z-10 w-full bg-[#ebebeb] border-t border-[#212631]/10">
                    <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_2fr] xl:grid-cols-[380px_1fr_380px] min-h-screen">

                        <div className="border-b lg:border-b-0 lg:border-r border-[#212631]/10 bg-[#ebebeb] relative">
                        ...
                        <div className="bg-[#ebebeb] border-b xl:border-b-0 xl:border-r border-[#212631]/10 min-h-screen">
                        ...
                        <div className="hidden xl:block bg-[#ebebeb] relative">
                            <div className="sticky top-20 p-8 h-max">
                                {selectedUserId ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center text-center p-12 border border-[#212631]/10 bg-[#ebebeb]">
                                        <span className="text-[10px] tracking-[0.18em] uppercase font-bold text-[#212631]/30">
                                            Profile Viewer
                                        </span>
                                        <p className="mt-4 text-[10px] uppercase tracking-widest text-[#212631]/50 leading-relaxed">
                    ...
                    {selectedPost && (
                        <div className="fixed inset-0 z-[200] flex items-center justify-center p-0 md:p-6">
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="absolute inset-0 bg-[#212631]/60 backdrop-blur-md"
                            ...
                            <motion.div
                                ...
                                className="relative z-10 flex flex-col bg-[#ebebeb] border border-[#212631]/10 w-full h-full md:h-auto md:max-w-4xl md:max-h-[85vh] overflow-hidden"
                            >
                                <div className="flex items-center justify-between px-5 py-4 border-b border-[#212631]/10 shrink-0 bg-[#ebebeb]">
                                    <span className="text-[10px] tracking-[0.18em] uppercase font-bold text-[#212631]/40">
                                        Post Details
                                    </span>
                                    <button
                                        onClick={() => setSelectedPost(null)}
                                        className="text-[#212631] opacity-40 hover:opacity-100 transition-opacity cursor-pointer flex items-center gap-2"
                                    >
                                ...
                                <div className="overflow-y-auto flex-1 p-6 md:p-10">
                                    ...
                                    {selectedPost.imageUrl && (
                                        <div className="w-full overflow-hidden border border-[#212631]/10 mb-10 bg-[#212631]/5 flex justify-center">
                                            <img src={selectedPost.imageUrl} alt="post" className="max-w-full h-auto max-h-[60vh] object-contain" />
                                        </div>
                                    )}

                                    <div className="pt-10 border-t border-[#212631]/10">
