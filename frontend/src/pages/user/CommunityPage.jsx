    ...
    return (
        <ReactLenis root>
            <div className="bg-[#ebebeb] text-[#212631] relative min-h-screen">
                ...
                {/* Intro Section - Kept Dark Text for contrast on #ebebeb */}
                ...
                {/* Main Feed Section - Background Green, Text White */}
                <main id="community-feed" className="relative z-10 w-full bg-[#26bc61] border-t border-white/20">
                    <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_2fr] xl:grid-cols-[380px_1fr_380px] min-h-screen">

                        <div className="border-b lg:border-b-0 lg:border-r border-white/20 bg-[#26bc61] relative">
                        ...
                        <div className="bg-[#26bc61] border-b xl:border-b-0 xl:border-r border-white/20 min-h-screen">
                            <div className="p-0 sm:p-5 md:p-8">
                                {loadingPosts ? (
                                    <div className="flex items-center justify-center py-32">
                                        <motion.div
                                            className="w-5 h-5 rounded-full border-[1.5px] border-white/30 border-t-white"
                                            animate={{ rotate: 360 }}
                        ...
                        <div className="hidden xl:block bg-[#26bc61] relative">
                            <div className="sticky top-20 p-8 h-max">
                                {selectedUserId ? (
                                    <PublicUserProfile userId={selectedUserId} onClose={() => setSelectedUserId(null)} />
                                ) : (
                                    <div className="flex flex-col items-center justify-center text-center p-12 border border-white/20 bg-[#26bc61]">
                                        <span className="text-[10px] tracking-[0.18em] uppercase font-bold text-white/50">
                                            Profile Viewer
                                        </span>
                                        <p className="mt-4 text-[10px] uppercase tracking-widest text-white/70 leading-relaxed">
                    ...
                    {selectedPost && (
                        <div className="fixed inset-0 z-[200] flex items-center justify-center p-0 md:p-6">
                            ...
                            <motion.div
                                ...
                                className="relative z-10 flex flex-col bg-[#26bc61] border border-white/20 w-full h-full md:h-auto md:max-w-4xl md:max-h-[85vh] overflow-hidden"
                            >
                                <div className="flex items-center justify-between px-5 py-4 border-b border-white/20 shrink-0 bg-[#26bc61]">
                                    <span className="text-[10px] tracking-[0.18em] uppercase font-bold text-white/60">
                                        Post Details
                                    </span>
                                    <button
                                        onClick={() => setSelectedPost(null)}
                                        className="text-white opacity-60 hover:opacity-100 transition-opacity cursor-pointer flex items-center gap-2"
                                    >
                                ...
                                <div className="overflow-y-auto flex-1 p-6 md:p-10">
                                    <div className="flex items-center gap-4 mb-8 cursor-pointer group w-max"
                                        ...
                                        <div className="flex flex-col">
                                            <span className="font-black uppercase text-white tracking-tight text-lg group-hover:underline">
                                    ...
                                    <p className="text-xl md:text-3xl font-medium leading-[1.3] text-white whitespace-pre-wrap mb-10 tracking-tight">
                                        {selectedPost.content}
                                    </p>

                                    {selectedPost.imageUrl && (
                                        <div className="w-full overflow-hidden border border-white/20 mb-10 bg-white/10 flex justify-center">
                                            <img src={selectedPost.imageUrl} alt="post" className="max-w-full h-auto max-h-[60vh] object-contain" />
                                        </div>
                                    )}

                                    <div className="pt-10 border-t border-white/20">
                                        <h3 className="font-black uppercase text-white tracking-tighter text-2xl mb-8">Discussion</h3>
                                        <CommentSection
