...
const EventsSection = () => {
    return (
        <section id="events-section" className="bg-[#ebebeb] w-full flex items-center justify-center py-6 sm:py-8 md:py-12 px-4 sm:px-6 md:px-8 lg:px-12">
            <div className="w-full max-w-[1600px] mx-auto bg-[#007a55] rounded-[2rem] md:rounded-[3rem] overflow-hidden relative flex flex-col min-h-[75vh] sm:min-h-[80vh] shadow-2xl">
                    ...
                    <div className="flex flex-col items-start gap-4">
                        ...
                        <div className="flex gap-4 mt-2">
                            {['ig', 'fb', 'x'].map((social, i) => (
                                <div key={i} className="w-8 h-8 rounded-full bg-[#ebebeb] text-[#007a55] flex items-center justify-center text-[10px] font-bold uppercase hover:bg-[#212631] hover:text-[#ebebeb] transition-colors cursor-pointer">
                                    {social}
                                </div>
                            ))}
                        </div>
