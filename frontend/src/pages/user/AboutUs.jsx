...
const AboutUs = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <section className="relative text-white py-28 sm:py-32 md:py-40 text-center bg-cover bg-center px-4" style={{ backgroundImage: 'linear-gradient(rgba(45,90,39,0.85), rgba(58,140,125,0.85)), url(https://images.unsplash.com/photo-1550358864-518f202c02ba)' }}>
