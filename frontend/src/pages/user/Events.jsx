            ...
            <div className="container mx-auto px-4 md:px-6 py-4 md:py-12 flex-grow">
                ...
                {!loading && !error && filteredEvents.length === 0 && (
                    <div className="flex flex-col items-center justify-center py-20">
                        ...
                        <p className="text-lg font-medium text-gray-500">No events available at the moment.</p>
                        <p className="text-sm text-gray-400 mt-1">Please check back later for upcoming events.</p>
                    </div>
                )}
