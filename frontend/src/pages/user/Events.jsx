...
const StatusBadge = ({ status, size = 'sm' }) => {
    const sizing = size === 'sm' ? 'text-[8px] px-1.5 py-0.5' : 'text-[10px] md:text-xs px-2.5 py-1';
    return (
        <span className={`inline-block border uppercase tracking-widest font-normal leading-none ${sizing} border-[#212631] text-[#212631] ${status === 'past' ? 'opacity-40' : ''}`}>
            {status}
        </span>
    );
};
...
const Events = () => {
    ...
    const MobileListRow = ({ event, index }) => {
        ...
        return (
            <motion.div
                ...
                className="group flex items-center gap-4 py-4 cursor-pointer border-b border-[#212631]/10 hover:bg-[#212631]/5 transition-colors"
                role="button"
                tabIndex={0}
            >
                <div className="w-14 h-14 flex-shrink-0 overflow-hidden border border-[#212631]/20">
                    <motion.img
                        src={event.imageUrl}
                        alt={event.title}
    ...
    const CalendarCell = ({ day }) => {
        ...
        return (
            <div className={`border-r border-b border-[#212631]/10 flex flex-col min-h-[100px] lg:min-h-[140px] ${day ? 'bg-[#ebebeb] hover:bg-[#212631]/5 transition-colors' : 'bg-[#212631]/5'}`}>
                {day && (
                    <>
                        <div className="px-2 pt-2 pb-1">
                            <span className={`inline-block text-[10px] lg:text-xs font-normal uppercase tracking-tighter leading-none ${isCurrentDay ? 'bg-[#212631] text-[#ebebeb] px-2 py-1' : 'text-[#212631]'}`}>
                                {day}
                            </span>
                        </div>
                        <div className="flex flex-col gap-1.5 px-1.5 pb-2 flex-1">
                            {dayEvents.slice(0, 2).map((event) => (
                                <motion.button
                                    key={event.id}
                                    onClick={() => setSelectedEvent(event)}
                                    className="w-full text-left overflow-hidden border border-[#212631]/20 bg-[#ebebeb] group flex items-center gap-2 p-1 cursor-pointer"
                                    whileHover={{ scale: 1.02 }}
                                    whileTap={{ scale: 0.98 }}
                                >
                                    <div className="w-8 h-8 flex-shrink-0 border border-[#212631]/10 overflow-hidden">
                            ...
                            {dayEvents.length > 2 && (
                                <button
                                    ...
                                    className="text-[8px] font-normal uppercase tracking-widest px-1 text-left text-[#212631]/60 hover:text-[#212631] transition-colors mt-1"
                                >
    ...
    return (
        <ReactLenis root>
            <div className="min-h-screen flex flex-col bg-[#ebebeb] text-[#212631]">
                <Header />
                ...
                <section className="pt-24 md:pt-32 pb-8 px-4 md:px-8 lg:px-12 max-w-[1600px] mx-auto w-full border-b border-[#212631]/10">
                    <motion.p
                        ...
                        className="text-[10px] md:text-xs uppercase tracking-[0.35em] font-normal mb-4 md:mb-6 text-[#212631]/50"
                    >
                        Zoo Bulusan Network
                    </motion.p>
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="overflow-hidden">
                                <motion.h1
                                    ...
                                    className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-normal uppercase tracking-tighter leading-[0.9] text-[#212631]"
                                >
                                    Activities &
                                </motion.h1>
                            </div>
                            <div className="overflow-hidden">
                                <motion.h1
                                    ...
                                    className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-normal uppercase tracking-tighter leading-[0.9] text-[#26bc61]"
                                >
                                    Events
                                </motion.h1>
                            </div>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 flex-wrap mt-2">
                                {[
                                    ...
                                    <div key={label} className="flex items-center gap-2 px-4 py-2 border border-[#212631]/20 bg-[#212631]/5">
                        ...
                        {FILTERS.map(f => {
                            ...
                            return (
                                <motion.button
                                    key={f}
                                    onClick={() => setFilter(f)}
                                    className={`text-[9px] md:text-[10px] uppercase tracking-[0.2em] px-6 py-3 font-normal border transition-colors whitespace-nowrap ${active ? 'border-[#212631] bg-[#212631] text-[#ebebeb]' : 'border-[#212631]/20 text-[#212631]/50 hover:bg-[#212631]/10 hover:text-[#212631]'}`}
                                >
                                    {label}
                                </motion.button>
                            );
                    ...
                    {!loading && !error && (
                        <>
                            <div className="hidden md:block">
                                <div className="flex items-center justify-between mb-6 bg-[#ebebeb] border border-[#212631]/20 p-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <button onClick={prevMonth} className="w-10 h-10 flex items-center justify-center border border-[#212631]/20 text-[#212631] hover:bg-[#212631] hover:text-[#ebebeb] transition-colors">
                                            <Icons.ChevronLeft />
                                        </button>
                                        <button onClick={() => setCalendarDate(new Date())} className="px-6 h-10 flex items-center justify-center text-[10px] uppercase tracking-widest font-normal border border-[#212631]/20 text-[#212631] hover:bg-[#212631] hover:text-[#ebebeb] transition-colors">
                                            Today
                                        </button>
                                        <button onClick={nextMonth} className="w-10 h-10 flex items-center justify-center border border-[#212631]/20 text-[#212631] hover:bg-[#212631] hover:text-[#ebebeb] transition-colors">
                                            <Icons.ChevronRight />
                                        </button>
                                    </div>
                                </div>

                                <div className="grid grid-cols-7 border-t border-l border-[#212631]/10 bg-[#ebebeb] shadow-xl">
                                    {DAYS_SHORT.map(day => (
                                ...
                                {!hasAnyEventInMonth && (
                                    <div className="text-center py-16 border border-t-0 border-[#212631]/10 bg-[#ebebeb]">
                            ...
                            <div className="md:hidden bg-[#ebebeb] border border-[#212631]/10 p-4">
                ...
                <section id="book-event" className="w-full bg-[#ffdd45] border-t border-[#212631]/10 pt-20 pb-40 px-4 md:px-8 relative z-10">
                    <div className="max-w-4xl mx-auto flex flex-col items-center">
                        <div className="text-center mb-16">
                            <span className="text-[10px] tracking-[0.3em] uppercase font-normal text-[#212631]/40 mb-4 block">Venue Protocol</span>
                        ...
                        <div className="w-full border border-[#212631]/20 p-8 md:p-12 bg-[#ebebeb] shadow-2xl relative">
                            ...
                            <form onSubmit={handleSubmitAttempt} className="flex flex-col gap-8 w-full z-10 relative">
                                <div className="flex flex-col gap-6">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[9px] tracking-[0.2em] uppercase font-normal text-[#212631]/60">Event Designation *</label>
                                        <input
                                            type="text"
                                            value={eventForm.venueEventName}
                                            onChange={e => setEventForm({ ...eventForm, venueEventName: sanitizeInput(e.target.value) })}
                                            className="w-full bg-[#212631]/5 border border-[#212631]/20 p-4 text-sm font-normal uppercase tracking-tight text-[#212631] focus:border-[#212631] outline-none transition-colors placeholder:text-[#212631]/30"
                                            required
                                        />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] tracking-[0.2em] uppercase font-normal text-[#212631]/60">Event Date *</label>
                                            <input
                                                type="date"
                                                value={eventForm.venueEventDate}
                                                onChange={e => setEventForm({ ...eventForm, venueEventDate: e.target.value })}
                                                min={getMinDate()}
                                                className="w-full bg-[#212631]/5 border border-[#212631]/20 p-4 text-sm font-normal uppercase tracking-wider text-[#212631] focus:border-[#212631] outline-none transition-colors h-[54px]"
                                                required
                                            />
                                        </div>
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] tracking-[0.2em] uppercase font-normal text-[#212631]/60">Event Time</label>
                                            <input
                                                type="time"
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] tracking-[0.2em] uppercase font-normal text-[#212631]/60">Headcount (Max 500) *</label>
                                            <input
                                                type="number"
                                                value={eventForm.numberOfParticipants}
                                                onChange={e => setEventForm({ ...eventForm, numberOfParticipants: e.target.value })}
                                                min="1" max="500"
                                                className="w-full bg-[#212631]/5 border border-[#212631]/20 p-4 text-sm font-normal uppercase tracking-tight text-[#212631] focus:border-[#212631] outline-none transition-colors"
                                                required
                                            />
                                        </div>
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] tracking-[0.2em] uppercase font-normal text-[#212631]/60">Contact Phone</label>
                                            <input
                                                type="tel"
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] tracking-[0.2em] uppercase font-normal text-[#212631]/60">Organizer Name *</label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] tracking-[0.2em] uppercase font-normal text-[#212631]/60">Organizer Email *</label>
                                            <input
                                                type="email"
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[9px] tracking-[0.2em] uppercase font-normal text-[#212631]/60">Event Details & Requirements</label>
                                        <textarea
                                            ...
                                            className="w-full bg-[#212631]/5 border border-[#212631]/20 p-4 text-sm font-normal text-[#212631] focus:border-[#212631] outline-none transition-colors resize-y min-h-[120px]"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-6 pt-6 border-t border-[#212631]/10">
                                    <label className="flex items-start gap-4 cursor-pointer group">
                                        <div className="mt-0.5 relative flex items-center justify-center">
                                            <input
                                                type="checkbox"
                                                required
                                                className="peer appearance-none w-5 h-5 border border-[#212631]/40 checked:bg-[#212631] checked:border-[#212631] transition-all cursor-pointer bg-transparent"
                                            />
                                    ...
                                    <button
                                        ...
                                        className="w-full py-5 bg-[#212631] text-[#ebebeb] border border-[#212631] text-[10px] tracking-[0.2em] uppercase font-normal hover:bg-transparent hover:text-[#212631] disabled:opacity-50 disabled:pointer-events-none transition-colors cursor-pointer"
                                    >
                    ...
                    {selectedEvent && (
                        ...
                        >
                            <motion.div
                                ...
                                className="w-full md:max-w-3xl overflow-hidden flex flex-col bg-[#ebebeb] border border-[#212631]/20 shadow-2xl max-h-[92vh]"
                            >
                                <div className="flex items-center justify-between px-6 py-4 border-b border-[#212631]/20 shrink-0 bg-[#ebebeb]">
                                    <span className="text-[10px] tracking-[0.2em] uppercase font-normal text-[#212631]/60">
                                        Event Details
                                    </span>
                                    <button
                                ...
                                <div className="overflow-y-auto flex-1 flex flex-col">
                                    <div className="w-full aspect-[16/7] overflow-hidden flex-shrink-0 border-b border-[#212631]/20">
                                    ...
                                    <div className="p-8 md:p-10 flex flex-col gap-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 border border-[#212631]/20 bg-[#212631]/5 p-5">
                                            <div className="flex flex-col gap-2">
                                                <h4 className="text-[9px] uppercase tracking-widest font-normal text-[#212631]/40">Time</h4>
                                                <p className="text-xs font-normal uppercase flex items-center gap-1.5 text-[#212631]">
                                                    <Icons.Clock />
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <h4 className="text-[9px] uppercase tracking-widest font-normal text-[#212631]/40">Location</h4>
                                                <p className="text-xs font-normal uppercase flex items-center gap-1.5 text-[#212631] truncate">
                                                    <Icons.Location />
                                        ...
                                        {selectedEvent.tags && selectedEvent.tags.length > 0 && (
                                            <div className="flex flex-wrap gap-2 pt-4">
                                                {selectedEvent.tags.map((tag, i) => (
                                                    <span key={i} className="border border-[#212631]/20 text-[9px] uppercase tracking-widest font-normal px-3 py-1.5 bg-[#ebebeb] text-[#212631]/60">
                                                        {tag}
                                                    </span>
                                                ))}
                                            </div>
                    ...
                    {showSubmitConfirm && (
                        <div className="fixed inset-0 z-[250] flex items-center justify-center p-4">
                            ...
                            <motion.div
                                ...
                                className="bg-[#ebebeb] border border-[#212631]/20 w-full max-w-md relative z-10 flex flex-col overflow-hidden shadow-2xl"
                            >
                                ...
                                <div className="p-8 bg-[#212631]/5 flex flex-col gap-4">
                                    {[
                                        ...
                                        <div key={label} className="flex justify-between items-center">
                                            <span className="text-[9px] tracking-widest uppercase font-normal text-[#212631]/50">{label}</span>
                                            <span className="text-[10px] font-normal uppercase text-[#212631] truncate max-w-[150px]">{value}</span>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="p-8 border-t border-[#212631]/20 flex gap-4 bg-[#ebebeb]">
                                    <button
                                        ...
                                        className="flex-1 py-4 border border-[#212631]/20 text-[9px] tracking-[0.18em] uppercase font-normal text-[#212631] hover:bg-[#212631]/5 transition-colors cursor-pointer"
                                    >
                                        Return
                                    </button>
                                    <button
                                        ...
                                        disabled={isSubmitting}
                                        className="flex-1 py-4 bg-[#212631] border border-[#212631] text-[9px] tracking-[0.18em] uppercase font-normal text-[#ebebeb] hover:bg-transparent hover:text-[#212631] disabled:opacity-50 transition-colors cursor-pointer"
                                    >
                    ...
                    {showConfirmation && confirmationData && (
                        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
                            ...
                            <motion.div
                                ...
                                className="bg-[#ebebeb] border border-[#212631]/20 w-full max-w-sm p-10 relative z-10 flex flex-col items-center text-center shadow-2xl"
                            >
                                <div className="mb-6 text-[#26bc61]"><Icons.Check /></div>
                                ...
                                <div className="w-full border border-[#212631]/20 bg-[#212631]/5 p-6 mb-8 flex flex-col items-center justify-center">
                                ...
                                <div className="w-full flex flex-col gap-3">
                                    <button
                                        ...
                                        className="w-full py-4 border border-[#212631]/20 text-[9px] tracking-[0.18em] uppercase font-normal text-[#212631] hover:bg-[#212631]/5 transition-colors cursor-pointer"
                                    >
                                        Dismiss
                                    </button>
                                    <button
                                        onClick={() => { setShowConfirmation(false); navigate('/reservations'); }}
                                        className="w-full py-4 bg-[#212631] border border-[#212631] text-[9px] tracking-[0.18em] uppercase font-normal text-[#ebebeb] hover:bg-transparent hover:text-[#212631] transition-colors cursor-pointer"
                                    >
                                        Manage Bookings
                                    </button>
                                </div>
