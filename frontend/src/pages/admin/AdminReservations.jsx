                                    ...
                                    <tr key={reservation.id} className="hover:bg-[#1e1e1e]/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <button
                                                    onClick={() => setDeleteConfirm({ ...reservation, type: activeTab === 'tickets' ? 'ticket' : 'event' })}
            ...
            {deleteConfirm && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-[#141414] border border-[#2a2a2a] rounded-2xl w-full max-w-sm p-6 text-center">
                        ...
                        <h3 className="text-xl font-bold text-white mb-2">Delete Reservation?</h3>
                        <p className="text-gray-400 mb-6">
                            Are you sure you want to delete reservation <span className="text-white font-medium">{deleteConfirm.reservation_reference}</span>? This action cannot be undone.
                        </p>
