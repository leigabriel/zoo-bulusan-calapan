        ...
        <div className="space-y-6">
            <section className="rounded-2xl border border-green-200 bg-white p-5 shadow-sm">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <p className="text-xs font-semibold uppercase tracking-wider text-green-600">Admin tools</p>
            ...
            <section className="rounded-2xl border border-emerald-200 bg-white p-5 shadow-sm">
                <div className="mb-4 flex items-center justify-between"><div><h2 className="text-lg font-bold text-gray-900">Post library</h2><p className="mt-1 text-xs text-gray-500">Review the full community publishing history</p></div><span className="rounded-full bg-emerald-50 px-3 py-1 text-xs font-bold text-emerald-700">{allPosts.length} total</span></div>
                <div className="space-y-4 max-h-[620px] overflow-auto pr-1">
                    {allPosts.map((post) => (
                        <article key={`all-${post.id}`} className="rounded-2xl border border-gray-200 bg-white p-4 transition hover:border-emerald-200 hover:shadow-sm">
