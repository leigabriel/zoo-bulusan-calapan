...
-- two-way chat (separate from Contact Support/user_messages)
...
CREATE TABLE ticket_reservations (
    ...
    INDEX idx_ticket_reservations_is_deleted (is_deleted),
...
CREATE TABLE event_reservations (
    ...
    INDEX idx_event_reservations_is_deleted (is_deleted),
    FOREIGN KEY (deleted_by) REFERENCES users(id) ON DELETE SET NULL ON UPDATE CASCADE,
